...
pkgs <- c('plyr', 'dplyr', 'magrittr', 'tidyverse', 'devtools', 'zoo', 'lubridate', 'stringr', 
          'rvest', 'googleVis', 'markdown', 'knitr', 'rmarkdown', 'htmltools', 'kable', 
          'kableExtra', 'formattable', 'recharts', 'radarchart', 'lubridate')
